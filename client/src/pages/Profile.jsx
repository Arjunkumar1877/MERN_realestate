    ...
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <img onClick={()=>fileRef.current.click()} src={formData?.avatar || currentUser.avatar} className='rounded-full h-24 w-24 object-cover cursor-pointer self-center' alt="profile" />
          ...
          <button disabled={loading} type='submit' className='bg-slate-700 text-white  rounded-lg p-3 uppercase hover:opacity-80'>{ loading ? "loading.." : "Update"}</button>
      ...
      <p className="text-green-700">{ updateSuccess ? "Upated successfully" : "" }</p>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div key={listing._id} className="border rounded-lg p-3 flex justify-between items-center gap-4">
             <Link to={`/listing/${listing._id}`}>
              <img src={listing.imageUrls[0]} className='h-16 w-16 object-contain' alt="" />
             </Link>
